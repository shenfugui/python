...
while(True):
    ...
    ret, frame = cap.read()
    #下面三行可以根据自己的电脑进行调节
    src = cv2.resize(frame,(100,50), interpolation=cv2.INTER_CUBIC)#窗口大小
    cv2.rectangle(src, (400, 100), (300, 300 ), (0, 255, 0))#框出截取位置
    roi = src[100:300 , 90:300]  # 获取手势框图
